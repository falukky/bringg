...
public class Browser {
    ...
    public static void open() throws Exception {
        ...
        String browser = Utils.getProperty("browser").toLowerCase();
        ...
        switch (OsCheck.getOperatingSystemType()) {
            case Windows:
                System.setProperty(propertyName, Utils.getCurrentRootLocation() + "\\src\\main\\java\\drivers\\windows\\" + browserType.toString() + ".exe");
                ExtentReport.extentTest.log(Status.INFO, "OS type: Windows");
                break;

            case Mac:
                System.setProperty(propertyName, Utils.getCurrentRootLocation() + "/src/main/java/drivers/mac/" + browserType.toString());
                ExtentReport.extentTest.log(Status.INFO, "OS type: MAC");
                break;

            case Linux:
                System.setProperty(propertyName, Utils.getCurrentRootLocation() + "/src/main/java/drivers/linux/" + browserType.toString());
